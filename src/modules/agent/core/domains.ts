...
export const GENERAL_DOMAIN: DomainConfig = {
  ...
  specificityDescription:
    "A real, concrete moment, number, or named detail from someone's actual experience.",
  groundingDescription:
    "Do not search for stats or fabricate anchors. Ground the post entirely in the specific details and context provided by the user.",
  examples: [
